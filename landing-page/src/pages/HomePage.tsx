...
export const HomePage: React.FC<HomePageProps> = ({ navigate, currentUser }) => {
  ...
  return (
    <div className="lp-route-container">
      ...
      <section className="lp-section-wide" style={{ paddingTop: '50px', paddingBottom: '50px', textAlign: 'center' }}>
        <div className="lp-container-wide">
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap', marginTop: '32px', marginBottom: '40px' }}>
            {currentUser ? (
              <a href="http://localhost:5178/dashboard" className="btn-primary-warm" style={{ padding: '14px 28px', fontSize: '1rem' }}>
                Open Investigation Workspace <ArrowRight size={18} />
              </a>
            ) : (
              <>
                <a href="http://localhost:5178/auth" className="btn-primary-warm" style={{ padding: '14px 28px', fontSize: '1rem' }}>
                  Launch Investigation Workspace <ArrowRight size={18} />
                </a>
                <a href="#/how-it-works" className="btn-outline" style={{ padding: '14px 24px', fontSize: '1rem' }}>
          ...
          {/* Key Platform Specifications Bar */}
      ...
      {/* ── 3. FEATURE BREAKDOWN — EDITORIAL ROWS ── */}
        ...
        <div className="lp-container-wide" style={{ maxWidth: '960px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <a href="http://localhost:5178/auth" className="btn-primary-warm" style={{ padding: '14px 32px', fontSize: '1.05rem' }}>
              Sign In & Get Started <ArrowRight size={18} />
            </a>
            <a href="#/documentation" className="btn-outline" style={{ padding: '14px 28px', fontSize: '1.05rem' }}>
