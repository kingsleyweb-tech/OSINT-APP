...
export const HelpPage: React.FC<{ navigate?: any }> = ({ navigate }) => {
        ...
        <div className="lp-container-wide">
          ...
          <div className="lp-help-links-grid">
            <div>
              ...
              <a href="#/documentation" className="btn-outline" style={{ fontSize: '0.85rem' }}>
                View Documentation
              </a>
            </div>
            ...
            <div>
              ...
              <a href="#/responsible-use" className="btn-outline" style={{ fontSize: '0.85rem' }}>
                View Ethics Policy
              </a>
            </div>
            ...
            <div>
              ...
              <a href="http://localhost:5178/auth" className="btn-primary-warm" style={{ fontSize: '0.85rem' }}>
