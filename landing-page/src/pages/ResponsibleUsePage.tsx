...
export const ResponsibleUsePage: React.FC<{ navigate?: any }> = ({ navigate }) => {
  return (
          ...
          <div style={{ lineHeight: 1.75, color: 'var(--text-muted)', width: '100%' }}>
            ...
            <div style={{ borderTop: '1px solid var(--border-color)', padding: '28px 0', borderBottom: '1px solid var(--border-color)' }}>
              ...
              <div style={{ textAlign: 'center', paddingTop: '10px' }}>
                <a href="http://localhost:5178/auth" className="btn-primary-warm" style={{ padding: '14px 32px', fontSize: '1rem' }}>
